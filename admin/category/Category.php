...
<body>
    ...
    <div class="navigation">
        ...
        <?php
            ...
            $sql_qtyRows = "select count(*) from category";
        ...
        <div class="table-content">
            ...
            <?php } ?>
            <span>
                <a href="./form_insert_category.php">
            ...
            <table class="table  " style="margin-top:10px;">
                ...
                <tbody   style="line-height: 80px;" >
                    ...
                    <td><img src="<?php echo $each['img_thumb']?>" alt="" style="height: 80px;"></td>
                    <td>
                        <a href="./form_update_category.php?id=<?php echo $each['id'] ?>"> 
