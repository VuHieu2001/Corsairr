        ...
        <div class="slide">
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" >
                ...
                <div class="carousel-inner"  >
                    ...
                    <img src="https://cwsmgmt.corsair.com/hybris/tlc/keyboards/images/hero-tlc-K70-RGB-PRO.png" class="slide-img" alt="..." >
                    <div class="slide-content ">
                        <h1>  GAMING KEYBOARDS </h1>
                        <p  style="font-weight: 500;">K70 RGB PRO <br>MECHANICAL GAMING KEYBOARD </p>
                        <button>
                            SHOP NOW
                        </button>
                    </div>
                    ...
                    <img src="https://cwsmgmt.corsair.com/hybris/tlc/keyboards/images/tlc_keyboards_banner_k65miniwht.jpg" class="slide-img" alt="..." >
                    <div class="slide-content">
                        <h1>GAMING KEYBOARDS</h1>
                        <p style="font-weight: 500;">K65 RGB MINI WHITE <br> 60% MECHANICAL <br>GAMING KEYBOARD</p>
                        <button>
                            SHOP NOW
                        </button>
                    </div>
                    ...
                    <div class="carousel-item">
                    <img src="https://cwsmgmt.corsair.com/hybris/tlc/keyboards/images/TLC_banner_keyboards_choose_keyboard.jpg" class="slide-img" alt="..." >
                    <div class="slide-content">
                        <h1>GAMING KEYBOARDS</h1>
                        <p>HELP ME CHOOSE A KEYBOARD</p>
                        <button>
                            LEARN MORE
                        </button>
                    </div>
