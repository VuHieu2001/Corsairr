        ...
        <div class="slide">
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" >
                ...
                <div class="carousel-inner"  >
                    ...
                    <img src="https://cwsmgmt.corsair.com/hybris/tlc/headsets/images/tlc_headsets_banner_hs80_wireless.jpg" class="slide-img" alt="..." >
                    <div class="slide-content ">
                        <h1>GAMING HEADSETS</h1>
                        <p  style="font-weight: 500;">HS80 RGB WIRELESS<br>GAMING HEADSET</p>
                        <button>
                            SHOP NOW
                        </button>
                    </div>
                    ...
                    <img src="https://cwsmgmt.corsair.com/hybris/tlc/headsets/images/tlc_headsets_banner_virtuosoxt.jpg" class="slide-img" alt="..." >
                    <div class="slide-content">
                        <h1>GAMING HEADSETS</h1>
                        <p style="font-weight: 500;">VIRTUOSO RGB WIRELESS XT <br> HIGH-FIDELITY GAMING HEADSET</p>
                        <button>
                            SHOP NOW
                        </button>
                    </div>
                    ...
                    <div class="carousel-item">
                    <img src="https://cwsmgmt.corsair.com/hybris/tlc/images/tlc_banner_gs_relaunch.jpg" class="slide-img" alt="..." >
                    <div class="slide-content">
                        <h1>GET GOOD</h1>
                        <p>PROFESSIONAL, ONE-ON-ONE TRAINING THAT BOOSTS YOUR SKILLS IN YOUR FAVORITE GAMES</p>
                        <button>
                            LEARN MORE
                        </button>
                    </div>
