        ...
        <div class="slide">
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" >
                ...
                <div class="carousel-inner"  >
                    ...
                    <img src="https://cwsmgmt.corsair.com/hybris/tlc/chairs/chair_tlc.jpg" class="slide-img" alt="..." >
                    <div class="slide-content ">
                        <h1>  GAMING CHAIRS </h1>
                        <p  style="font-weight: 500;">BUILT FOR COMFORT </p>
                        <!-- <button>
                            SHOP NOW
                        </button> -->
                    </div>
