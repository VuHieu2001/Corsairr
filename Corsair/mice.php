        ...
        <div class="slide">
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" >
                ...
                <div class="carousel-inner"  >
                    ...
                    <img src="https://cwsmgmt.corsair.com/hybris/tlc/mice/images/tlc_banner_mice_sabre_rgb_pro_wireless.jpg" class="slide-img" alt="..." >
                    <div class="slide-content ">
                        <h1> GAMING MICE </h1>
                        <p  style="font-weight: 500;">SABRE RGB PRO WIRELESS CHAMPION SERIES <br>ULTRA-LIGHTWEIGHT GAMING MOUSE</p>
                        <button>
                            SHOP NOW
                        </button>
                    </div>
                    ...
                    <img src="https://cwsmgmt.corsair.com/hybris/tlc/mice/NIGHTSWORD_RGB_32.jpg" class="slide-img" alt="..." >
                    <div class="slide-content">
                        <h1>GAMING MICE</h1>
                        <p style="font-weight: 500;">NIGHTSWORD RGB GAMING MOUSE </p>
                        <button>
                            SHOP NOW
                        </button>
                    </div>
